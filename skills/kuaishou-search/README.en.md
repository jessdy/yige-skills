...
- Visit [YigeHub](https://yige.zone?source=github) to register and get your `YIGE_API_KEY`.
- Configure your device's environment variable `YIGE_API_KEY` before using this skill.
