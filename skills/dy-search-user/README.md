...
- `POST https://yige.zone/v1/douyin/search/fetch_user_search_v2`
...
| 意图 | 示例话术 | 效果 |
|------|----------|------|
| 直接取数 | 「用 dy-search-user 帮我取数」 | 调用脚本并汇总结果 |
...
`dy-user-profile`、`dy-user-posts`、`dy-search-suggest`
