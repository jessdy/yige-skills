...
- `POST https://yige.zone/v1/douyin/search/fetch_search_suggest`
...
| 意图 | 示例话术 | 效果 |
|------|----------|------|
| 直接取数 | 「用 dy-search-suggest 帮我取数」 | 调用脚本并汇总结果 |
...
`dy-hot-search`、`dy-search-video`、`dy-search-general`
