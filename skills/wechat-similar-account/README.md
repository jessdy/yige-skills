...
- **7 维度推荐理由**：每个推荐账号附带从爆文洞察、内容聚焦、更新节奏到互动率、分享率的详细分析，数据稀疏时自动补充一格指数等维度。
...
- **账号诊断**：展示查询账号的基本信息、一格指数、阅读数据及近 5 篇文章数据。
...
**查询账号基本信息**：账号名称、ID、分类、一格指数、平均阅读数、近 7 天数据及近 5 篇文章列表

**✨ 同阶对标（5 个）**：阅读量与你最接近的账号，可直接复制其内容策略

| 账号名称 | 一格指数 | 平均阅读数 | 近 7 天阅读数 | 近 7 日发文数 | 推荐理由 |
