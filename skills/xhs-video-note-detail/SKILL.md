...
description: 根据 note_id 或分享链接获取视频笔记详情与互动数据。需要一格数据 API Key。
---

## 简介

调用[一格数据](https://yige.zone) 小红书接口 `GET /v1/xiaohongshu/app_v2/get_video_note_detail`，返回结构化 JSON。

**何时使用：** 用户给了视频笔记链接或 note_id
...
接口文档参考：https://docs.tikhub.io/420136392e0
