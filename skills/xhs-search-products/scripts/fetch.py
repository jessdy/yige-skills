...
def main() -> None:
    p = argparse.ArgumentParser(description="小红书搜索商品")
    add_common(p)
    ...
    result = request("GET", PATH, api_key, params={"keyword": args.keyword, "page": args.page, "search_id": args.search_id or None, "source": "explore_feed"})
