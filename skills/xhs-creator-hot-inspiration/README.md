# 小红书创作者热点灵感 / xhs-creator-hot-inspiration
...
- `GET https://yige.zone/v1/xiaohongshu/app_v2/get_creator_hot_inspiration_feed`
...
| 意图 | 示例话术 | 效果 |
|------|----------|------|
| 直接取数 | 「用 xhs-creator-hot-inspiration 帮我取数」 | 调用脚本并汇总结果 |
