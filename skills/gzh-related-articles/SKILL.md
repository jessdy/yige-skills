...
description: 根据文章 URL 拉取关联/推荐文章列表；未开启关联时返回空。需要一格数据 API Key。
---

## 简介

调用[一格数据](https://yige.zone) 公众号接口 `/v1/wechat_mp/v2/fetch_related_articles`，返回结构化 JSON。

**何时使用：** 用户要看文章底部关联阅读、相关推荐
...
接口文档参考：https://docs.tikhub.io/472974855e0
