# 小红书商品评价总览 / xhs-product-review-overview
...
- `GET https://yige.zone/v1/xiaohongshu/app_v2/get_product_review_overview`
...
| 意图 | 示例话术 | 效果 |
|------|----------|------|
| 直接取数 | 「用 xhs-product-review-overview 帮我取数」 | 调用脚本并汇总结果 |
