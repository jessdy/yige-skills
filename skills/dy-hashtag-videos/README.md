...
- `GET https://yige.zone/v1/douyin/app/v3/fetch_hashtag_video_list`
...
| 意图 | 示例话术 | 效果 |
|------|----------|------|
| 直接取数 | 「用 dy-hashtag-videos 帮我取数」 | 调用脚本并汇总结果 |
...
`dy-hashtag-detail`、`dy-video-stats`
