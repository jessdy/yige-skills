...
description: 根据文章 URL 拉取阅读量、点赞、在看、分享、收藏、评论数等互动指标。需要一格数据 API Key。
---

## 简介

调用[一格数据](https://yige.zone) 公众号接口 `/v1/wechat_mp/v2/fetch_article_stats`，返回结构化 JSON。

**何时使用：** 用户要查某篇文章阅读量、点赞、在看、分享等数据
...
接口文档参考：https://docs.tikhub.io/472974852e0
