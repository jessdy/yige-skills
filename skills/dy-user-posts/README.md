...
- `GET https://yige.zone/v1/douyin/app/v3/fetch_user_post_videos`
...
| 意图 | 示例话术 | 效果 |
|------|----------|------|
| 直接取数 | 「用 dy-user-posts 帮我取数」 | 调用脚本并汇总结果 |
...
`dy-user-profile`、`dy-video-detail`、`dy-video-stats`
