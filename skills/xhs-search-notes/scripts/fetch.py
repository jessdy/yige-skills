...
def main() -> None:
    p = argparse.ArgumentParser(description="小红书搜索笔记")
    add_common(p)
    p.add_argument("--keyword", required=True)
    p.add_argument("--page", type=int, default=1)
    p.add_argument("--sort-type", default="general")
    ...
    params = {
        ...
        "search_id": args.search_id or None,
        "search_session_id": args.search_session_id or None,
    }
