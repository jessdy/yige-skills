# 小红书商品推荐 / xhs-product-recommendations
...
- `GET https://yige.zone/v1/xiaohongshu/app_v2/get_product_recommendations`
...
| 意图 | 示例话术 | 效果 |
|------|----------|------|
| 直接取数 | 「用 xhs-product-recommendations 帮我取数」 | 调用脚本并汇总结果 |
