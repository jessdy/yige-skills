...
def main() -> None:
    p = argparse.ArgumentParser(description="小红书商品推荐")
    add_common(p)
    ...
    result = request("GET", PATH, api_key, params={"sku_id": args.sku_id, "cursor_score": args.cursor_score or None, "region": args.region})
