...
- `GET https://yige.zone/v1/douyin/app/v3/handler_user_profile`
...
| 意图 | 示例话术 | 效果 |
|------|----------|------|
| 直接取数 | 「用 dy-user-profile 帮我取数」 | 调用脚本并汇总结果 |
...
`dy-search-user`、`dy-user-posts`、`dy-user-fans`
