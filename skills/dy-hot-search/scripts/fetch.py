...
def main() -> None:
    p = argparse.ArgumentParser(description="抖音热搜榜")
    add_common(p)
    p.add_argument('--board-type', dest='board_type', default='0', help='榜单类型，默认 0')
    p.add_argument('--board-sub-type', dest='board_sub_type', default='', help='榜单子类型')
    args = p.parse_args()
