...
使用 yige.zone API 解析 Instagram 视频链接，直接返回无水印视频下载链接
...
API_URL = "https://yige.zone/story/api/parseWork/videoDownload/instagram"
...
def main():
    parser = argparse.ArgumentParser(
        description="Instagram视频下载 - 使用 yige.zone API 解析视频并返回下载链接",
