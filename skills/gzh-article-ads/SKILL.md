...
description: 根据文章 URL 拉取文中/文末广告位信息；无广告时返回空。需要一格数据 API Key。
---

## 简介

调用[一格数据](https://yige.zone) 公众号接口 `/v1/wechat_mp/v2/fetch_article_ad`，返回结构化 JSON。

**何时使用：** 用户要分析文章广告位、竞品广告投放
...
接口文档参考：https://docs.tikhub.io/472974856e0
